...
// checks if the WebhookReceiveResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookReceiveResponse{}

// WebhookReceiveResponse struct for WebhookReceiveResponse
...
type _WebhookReceiveResponse WebhookReceiveResponse
...
func (o WebhookReceiveResponse) MarshalJSON() ([]byte, error) {
...
func (o WebhookReceiveResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookReceiveResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookReceiveResponse := _WebhookReceiveResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookReceiveResponse)

	if err != nil {
		return err
	}

	*o = WebhookReceiveResponse(varWebhookReceiveResponse)

	return err
}

type NullableWebhookReceiveResponse struct {
	value *WebhookReceiveResponse
	isSet bool
}

func (v NullableWebhookReceiveResponse) Get() *WebhookReceiveResponse {
	return v.value
}

func (v *NullableWebhookReceiveResponse) Set(val *WebhookReceiveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookReceiveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookReceiveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookReceiveResponse(val *WebhookReceiveResponse) *NullableWebhookReceiveResponse {
	return &NullableWebhookReceiveResponse{value: val, isSet: true}
}

func (v NullableWebhookReceiveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookReceiveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
