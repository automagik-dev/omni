...
// checks if the SupportedChannel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportedChannel{}

// SupportedChannel struct for SupportedChannel
...
type _SupportedChannel SupportedChannel
...
func (o SupportedChannel) MarshalJSON() ([]byte, error) {
...
func (o SupportedChannel) ToMap() (map[string]interface{}, error) {
...
func (o *SupportedChannel) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportedChannel := _SupportedChannel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSupportedChannel)

	if err != nil {
		return err
	}

	*o = SupportedChannel(varSupportedChannel)

	return err
}

type NullableSupportedChannel struct {
	value *SupportedChannel
	isSet bool
}

func (v NullableSupportedChannel) Get() *SupportedChannel {
	return v.value
}

func (v *NullableSupportedChannel) Set(val *SupportedChannel) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportedChannel) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportedChannel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportedChannel(val *SupportedChannel) *NullableSupportedChannel {
	return &NullableSupportedChannel{value: val, isSet: true}
}

func (v NullableSupportedChannel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportedChannel) UnmarshalJSON(src []byte) error {
	v.isSet = true
