...
export class RouteService {
  ...
  async create(instanceId: string, data: CreateAgentRoute): Promise<AgentRoute> {
    const routeData: NewAgentRoute = {
      ...
      messageDebounceMode: data.messageDebounceMode ?? null,
      messageDebounceMinMs: data.messageDebounceMinMs ?? null,
      ...
      messageSplitDelayMaxMs: data.messageSplitDelayMaxMs ?? null,
      enableAutoSplit: data.enableAutoSplit ?? null,
      reactionAck: data.reactionAck ?? null,
      reactionAckEmoji: data.reactionAckEmoji ?? null,
      ackTimeoutMs: data.ackTimeoutMs ?? null,
      agentAckMessage: data.agentAckMessage ?? null,
