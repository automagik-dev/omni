# omni_generated.ProfilesApi

All URIs are relative to */api/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_user_profile**](ProfilesApi.md#get_user_profile) | **GET** /instances/{id}/users/{userId}/profile | Fetch user profile
...
with omni_generated.ApiClient(configuration) as api_client:
    ...
    api_instance = omni_generated.ProfilesApi(api_client)
