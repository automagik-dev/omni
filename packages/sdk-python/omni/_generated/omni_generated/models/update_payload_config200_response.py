...
class UpdatePayloadConfig200Response(BaseModel):
    """
    UpdatePayloadConfig200Response
    """ # noqa: E501
    data: ListPayloadConfigs200ResponseItemsInner
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ListPayloadConfigs200ResponseItemsInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
