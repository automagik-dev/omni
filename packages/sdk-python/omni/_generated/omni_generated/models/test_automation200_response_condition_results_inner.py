...
class TestAutomation200ResponseConditionResultsInner(BaseModel):
    """
    TestAutomation200ResponseConditionResultsInner
    """ # noqa: E501
    condition: ListAutomations200ResponseItemsInnerTriggerConditionsInner
    passed: StrictBool
    __properties: ClassVar[List[str]] = ["condition", "passed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "condition": ListAutomations200ResponseItemsInnerTriggerConditionsInner.from_dict(obj["condition"]) if obj.get("condition") is not None else None,
