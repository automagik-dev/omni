...
class GetEventsBySender200ResponseMeta(BaseModel):
    """
    GetEventsBySender200ResponseMeta
    """ # noqa: E501
    total: StrictInt
    has_more: StrictBool = Field(alias="hasMore")
    __properties: ClassVar[List[str]] = ["total", "hasMore"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetEventsBySender200ResponseMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetEventsBySender200ResponseMeta from a dict"""
        if obj is None:
            return None
