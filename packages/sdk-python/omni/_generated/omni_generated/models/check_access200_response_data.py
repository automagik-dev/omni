...
class CheckAccess200ResponseData(BaseModel):
    """
    CheckAccess200ResponseData
    """ # noqa: E501
    allowed: StrictBool = Field(description="Whether access is allowed")
    rule: Optional[CheckAccess200ResponseDataRule]
    reason: Optional[StrictStr] = Field(description="Reason for decision")
    __properties: ClassVar[List[str]] = ["allowed", "rule", "reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rule": CheckAccess200ResponseDataRule.from_dict(obj["rule"]) if obj.get("rule") is not None else None,
