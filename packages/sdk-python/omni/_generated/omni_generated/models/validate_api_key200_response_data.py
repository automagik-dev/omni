...
class ValidateApiKey200ResponseData(BaseModel):
    """
    ValidateApiKey200ResponseData
    """ # noqa: E501
    valid: StrictBool = Field(description="Whether the API key is valid")
    key_prefix: StrictStr = Field(description="Truncated key prefix for identification", alias="keyPrefix")
    key_name: StrictStr = Field(description="Key name (primary or custom name)", alias="keyName")
    scopes: List[StrictStr] = Field(description="Scopes granted to this key")
    __properties: ClassVar[List[str]] = ["valid", "keyPrefix", "keyName", "scopes"]
