...
class LinkIdentitiesRequest(BaseModel):
    ...
    """ # noqa: E501
    identity_a: UUID = Field(description="First identity ID", alias="identityA")
    identity_b: UUID = Field(description="Second identity ID", alias="identityB")
    __properties: ClassVar[List[str]] = ["identityA", "identityB"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identityA": obj.get("identityA"),
            "identityB": obj.get("identityB")
        })
        return _obj
