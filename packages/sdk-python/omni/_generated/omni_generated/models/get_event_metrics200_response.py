...
class GetEventMetrics200Response(BaseModel):
    """
    GetEventMetrics200Response
    """ # noqa: E501
    data: GetEventMetrics200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetEventMetrics200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
