...
class SendContactRequest(BaseModel):
    ...
    contact: SendContactRequestContact
    __properties: ClassVar[List[str]] = ["instanceId", "to", "contact"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "to": obj.get("to"),
            "contact": SendContactRequestContact.from_dict(obj["contact"]) if obj.get("contact") is not None else None
        })
        return _obj
