...
class GetDeadLetterStats200Response(BaseModel):
    """
    GetDeadLetterStats200Response
    """ # noqa: E501
    data: GetDeadLetterStats200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetDeadLetterStats200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
