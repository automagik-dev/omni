...
class SendTextMessage201Response(BaseModel):
    """
    SendTextMessage201Response
    """ # noqa: E501
    data: SendTextMessage201ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SendTextMessage201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
