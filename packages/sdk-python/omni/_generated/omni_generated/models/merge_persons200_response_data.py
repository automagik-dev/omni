...
class MergePersons200ResponseData(BaseModel):
    """
    MergePersons200ResponseData
    """ # noqa: E501
    person: SearchPersons200ResponseItemsInner
    merged_identity_ids: List[UUID] = Field(alias="mergedIdentityIds")
    deleted_person_id: UUID = Field(alias="deletedPersonId")
    __properties: ClassVar[List[str]] = ["person", "mergedIdentityIds", "deletedPersonId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mergedIdentityIds": obj.get("mergedIdentityIds"),
            "deletedPersonId": obj.get("deletedPersonId")
        })
        return _obj
