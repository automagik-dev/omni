...
class ResolveDeadLetterRequest(BaseModel):
    ...
    """ # noqa: E501
    note: Annotated[str, Field(min_length=1, strict=True, max_length=500)] = Field(description="Resolution note")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResolveDeadLetterRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResolveDeadLetterRequest from a dict"""
        if obj is None:
            return None
