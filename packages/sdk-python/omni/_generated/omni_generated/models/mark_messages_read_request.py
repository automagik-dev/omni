...
class MarkMessagesReadRequest(BaseModel):
    ...
    chat_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Chat ID containing the messages", alias="chatId")
    message_ids: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=1, max_length=100)] = Field(description="Message IDs to mark as read", alias="messageIds")
    __properties: ClassVar[List[str]] = ["instanceId", "chatId", "messageIds"]
