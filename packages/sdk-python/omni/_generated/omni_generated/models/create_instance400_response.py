...
class CreateInstance400Response(BaseModel):
    """
    CreateInstance400Response
    """ # noqa: E501
    error: CreateInstance400ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": CreateInstance400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
