...
class ListInstanceContacts200ResponseMeta(BaseModel):
    """
    ListInstanceContacts200ResponseMeta
    """ # noqa: E501
    total_fetched: Union[StrictFloat, StrictInt] = Field(alias="totalFetched")
    has_more: StrictBool = Field(alias="hasMore")
    cursor: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["totalFetched", "hasMore", "cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "totalFetched": obj.get("totalFetched"),
