...
class GetDeadLetter200Response(BaseModel):
    """
    GetDeadLetter200Response
    """ # noqa: E501
    data: ListDeadLetters200ResponseItemsInner
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ListDeadLetters200ResponseItemsInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
