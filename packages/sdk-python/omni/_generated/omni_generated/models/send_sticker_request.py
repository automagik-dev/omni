...
class SendStickerRequest(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="Sticker URL")
    var_base64: Optional[StrictStr] = Field(default=None, description="Base64 encoded sticker", alias="base64")
    __properties: ClassVar[List[str]] = ["instanceId", "to", "url", "base64"]
