...
class GetRecentLogs200Response(BaseModel):
    """
    GetRecentLogs200Response
    """ # noqa: E501
    items: List[GetRecentLogs200ResponseItemsInner]
    meta: GetRecentLogs200ResponseMeta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [GetRecentLogs200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "meta": GetRecentLogs200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
