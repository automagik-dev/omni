...
class UnlinkIdentity200ResponseData(BaseModel):
    """
    UnlinkIdentity200ResponseData
    """ # noqa: E501
    person: SearchPersons200ResponseItemsInner
    identity: GetPersonPresence200ResponseDataIdentitiesInner
    __properties: ClassVar[List[str]] = ["person", "identity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identity": GetPersonPresence200ResponseDataIdentitiesInner.from_dict(obj["identity"]) if obj.get("identity") is not None else None
        })
        return _obj
