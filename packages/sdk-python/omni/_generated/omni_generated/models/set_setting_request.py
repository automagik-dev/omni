...
class SetSettingRequest(BaseModel):
    ...
    SetSettingRequest
    """ # noqa: E501
    value: Optional[Any] = Field(default=None, description="Setting value")
    reason: Optional[StrictStr] = Field(default=None, description="Reason for change (audit)")
    __properties: ClassVar[List[str]] = ["value", "reason"]
