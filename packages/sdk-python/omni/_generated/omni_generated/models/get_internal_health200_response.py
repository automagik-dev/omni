...
class GetInternalHealth200Response(BaseModel):
    """
    ...
    memory: GetInternalHealth200ResponseMemory
    __properties: ClassVar[List[str]] = ["status", "service", "pid", "memory"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pid": obj.get("pid"),
            "memory": GetInternalHealth200ResponseMemory.from_dict(obj["memory"]) if obj.get("memory") is not None else None
        })
        return _obj
