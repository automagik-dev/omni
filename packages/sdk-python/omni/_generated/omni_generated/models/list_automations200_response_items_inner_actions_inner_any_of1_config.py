...
class ListAutomations200ResponseItemsInnerActionsInnerAnyOf1Config(BaseModel):
    """
    ...
    content_template: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="contentTemplate")
    __properties: ClassVar[List[str]] = ["instanceId", "to", "contentTemplate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListAutomations200ResponseItemsInnerActionsInnerAnyOf1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListAutomations200ResponseItemsInnerActionsInnerAnyOf1Config from a dict"""
        if obj is None:
            return None
