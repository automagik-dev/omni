...
class GetHealth200ResponseChecks(BaseModel):
    """
    GetHealth200ResponseChecks
    """ # noqa: E501
    database: GetHealth200ResponseChecksDatabase
    nats: GetHealth200ResponseChecksDatabase
    __properties: ClassVar[List[str]] = ["database", "nats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "database": GetHealth200ResponseChecksDatabase.from_dict(obj["database"]) if obj.get("database") is not None else None,
            "nats": GetHealth200ResponseChecksDatabase.from_dict(obj["nats"]) if obj.get("nats") is not None else None
        })
        return _obj
