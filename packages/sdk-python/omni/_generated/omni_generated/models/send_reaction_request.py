...
class SendReactionRequest(BaseModel):
    ...
    to: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Chat ID")
    message_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Message ID to react to", alias="messageId")
    emoji: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Emoji to react with")
    __properties: ClassVar[List[str]] = ["instanceId", "to", "messageId", "emoji"]
