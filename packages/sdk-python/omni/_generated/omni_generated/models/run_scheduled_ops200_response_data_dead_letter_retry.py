...
class RunScheduledOps200ResponseDataDeadLetterRetry(BaseModel):
    """
    ...
    succeeded: StrictInt
    failed: StrictInt
    __properties: ClassVar[List[str]] = ["attempted", "succeeded", "failed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RunScheduledOps200ResponseDataDeadLetterRetry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RunScheduledOps200ResponseDataDeadLetterRetry from a dict"""
        if obj is None:
            return None
