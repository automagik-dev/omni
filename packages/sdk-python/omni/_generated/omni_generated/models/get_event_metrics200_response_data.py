...
class GetEventMetrics200ResponseData(BaseModel):
    """
    GetEventMetrics200ResponseData
    """ # noqa: E501
    total: StrictInt = Field(description="Total events")
    today: StrictInt = Field(description="Events today")
    by_type: Dict[str, Union[StrictFloat, StrictInt]] = Field(description="Count by type", alias="byType")
    by_channel: Dict[str, Union[StrictFloat, StrictInt]] = Field(description="Count by channel", alias="byChannel")
    avg_processing_time: Union[StrictFloat, StrictInt] = Field(description="Avg processing time (ms)", alias="avgProcessingTime")
    __properties: ClassVar[List[str]] = ["total", "today", "byType", "byChannel", "avgProcessingTime"]
