...
class SearchPersons200ResponseItemsInner(BaseModel):
    """
    SearchPersons200ResponseItemsInner
    """ # noqa: E501
    id: UUID = Field(description="Person UUID")
    ...
    phone: Optional[StrictStr] = Field(description="Phone number")
    ...
    __properties: ClassVar[List[str]] = ["id", "displayName", "email", "phone", "createdAt", "updatedAt"]
