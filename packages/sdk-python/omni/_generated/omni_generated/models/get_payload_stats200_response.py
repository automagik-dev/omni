...
class GetPayloadStats200Response(BaseModel):
    """
    GetPayloadStats200Response
    """ # noqa: E501
    data: GetPayloadStats200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetPayloadStats200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
