...
class GetEventsBySender200Response(BaseModel):
    """
    GetEventsBySender200Response
    """ # noqa: E501
    items: List[ListEvents200ResponseItemsInner]
    meta: GetEventsBySender200ResponseMeta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GetEventsBySender200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
