...
class MergePersonsRequest(BaseModel):
    ...
    MergePersonsRequest
    """ # noqa: E501
    source_person_id: UUID = Field(description="Person to merge from (will be deleted)", alias="sourcePersonId")
    target_person_id: UUID = Field(description="Person to merge into (will be kept)", alias="targetPersonId")
    reason: Optional[StrictStr] = Field(default=None, description="Reason for merge")
    __properties: ClassVar[List[str]] = ["sourcePersonId", "targetPersonId", "reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sourcePersonId": obj.get("sourcePersonId"),
            "targetPersonId": obj.get("targetPersonId"),
