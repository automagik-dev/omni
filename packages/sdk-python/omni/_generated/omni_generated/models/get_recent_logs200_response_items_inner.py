...
class GetRecentLogs200ResponseItemsInner(BaseModel):
    """
    GetRecentLogs200ResponseItemsInner
    """ # noqa: E501
    time: Union[StrictFloat, StrictInt] = Field(description="Timestamp (ms)")
    level: StrictStr = Field(description="Log level")
    module: StrictStr = Field(description="Module name")
    msg: StrictStr = Field(description="Log message")
    __properties: ClassVar[List[str]] = ["time", "level", "module", "msg"]
