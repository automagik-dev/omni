...
class ListInstanceGroups200Response(BaseModel):
    """
    ListInstanceGroups200Response
    """ # noqa: E501
    items: List[ListInstanceGroups200ResponseItemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ListInstanceGroups200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
