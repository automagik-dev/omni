...
class SearchEventsRequestFilters(BaseModel):
    """
    SearchEventsRequestFilters
    """ # noqa: E501
    channel: Optional[List[StrictStr]] = Field(default=None, description="Channel types")
    instance_id: Optional[UUID] = Field(default=None, description="Instance UUID", alias="instanceId")
    person_id: Optional[UUID] = Field(default=None, description="Person UUID", alias="personId")
    event_type: Optional[List[StrictStr]] = Field(default=None, description="Event types", alias="eventType")
    content_type: Optional[List[StrictStr]] = Field(default=None, description="Content types", alias="contentType")
    direction: Optional[StrictStr] = Field(default=None, description="Direction")
    ...
    __properties: ClassVar[List[str]] = ["channel", "instanceId", "personId", "eventType", "contentType", "direction", "since", "until"]
