...
class GetHealth200ResponseChecksDatabase(BaseModel):
    """
    GetHealth200ResponseChecksDatabase
    """ # noqa: E501
    status: StrictStr = Field(description="Check status")
    latency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Latency in milliseconds")
    error: Optional[StrictStr] = Field(default=None, description="Error message if status is error")
    details: Optional[Dict[str, Any]] = Field(default=None, description="Additional details")
    __properties: ClassVar[List[str]] = ["status", "latency", "error", "details"]
