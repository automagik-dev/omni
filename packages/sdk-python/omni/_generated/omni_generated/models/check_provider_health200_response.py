...
class CheckProviderHealth200Response(BaseModel):
    """
    CheckProviderHealth200Response
    """ # noqa: E501
    healthy: StrictBool = Field(description="Whether healthy")
    latency: Optional[Union[StrictFloat, StrictInt]] = Field(description="Latency (ms)")
    error: Optional[StrictStr] = Field(description="Error message")
    __properties: ClassVar[List[str]] = ["healthy", "latency", "error"]
