...
class ListAutomations200ResponseItemsInnerActionsInnerAnyOf(BaseModel):
    """
    ListAutomations200ResponseItemsInnerActionsInnerAnyOf
    """ # noqa: E501
    type: StrictStr
    config: ListAutomations200ResponseItemsInnerActionsInnerAnyOfConfig
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListAutomations200ResponseItemsInnerActionsInnerAnyOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListAutomations200ResponseItemsInnerActionsInnerAnyOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "config": ListAutomations200ResponseItemsInnerActionsInnerAnyOfConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
