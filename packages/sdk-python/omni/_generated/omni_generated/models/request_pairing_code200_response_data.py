...
class RequestPairingCode200ResponseData(BaseModel):
    """
    RequestPairingCode200ResponseData
    """ # noqa: E501
    code: StrictStr = Field(description="Pairing code to enter on phone")
    phone_number: StrictStr = Field(description="Masked phone number", alias="phoneNumber")
    message: StrictStr = Field(description="Instructions for user")
    expires_in: Union[StrictFloat, StrictInt] = Field(description="Seconds until code expires", alias="expiresIn")
    __properties: ClassVar[List[str]] = ["code", "phoneNumber", "message", "expiresIn"]
