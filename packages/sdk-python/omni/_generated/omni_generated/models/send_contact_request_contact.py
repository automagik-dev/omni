...
class SendContactRequestContact(BaseModel):
    """
    SendContactRequestContact
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Contact name")
    ...
    __properties: ClassVar[List[str]] = ["name", "phone", "email", "organization"]
