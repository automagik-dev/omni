...
class CreateAccessRule201Response(BaseModel):
    """
    CreateAccessRule201Response
    """ # noqa: E501
    data: ListAccessRules200ResponseItemsInner
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ListAccessRules200ResponseItemsInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
