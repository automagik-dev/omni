...
class GetEventPayloadByStage200ResponseData(BaseModel):
    """
    ...
    payload: Optional[Any] = Field(default=None, description="Decompressed payload data")
    __properties: ClassVar[List[str]] = ["id", "eventId", "stage", "mimeType", "sizeBytes", "hasData", "createdAt", "payload"]
