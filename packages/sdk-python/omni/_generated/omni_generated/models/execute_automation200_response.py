...
class ExecuteAutomation200Response(BaseModel):
    """
    ExecuteAutomation200Response
    """ # noqa: E501
    automation_id: UUID = Field(alias="automationId")
    triggered: StrictBool = Field(description="Whether the automation was triggered (event type matched)")
    results: List[ExecuteAutomation200ResponseResultsInner] = Field(description="Results of each action execution")
    __properties: ClassVar[List[str]] = ["automationId", "triggered", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ExecuteAutomation200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
