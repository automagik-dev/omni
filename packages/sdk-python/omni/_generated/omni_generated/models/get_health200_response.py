...
class GetHealth200Response(BaseModel):
    ...
    uptime: StrictInt = Field(description="Uptime in seconds")
    timestamp: datetime = Field(description="Current timestamp")
    checks: GetHealth200ResponseChecks
    instances: Optional[GetHealth200ResponseInstances] = None
    __properties: ClassVar[List[str]] = ["status", "version", "uptime", "timestamp", "checks", "instances"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "checks": GetHealth200ResponseChecks.from_dict(obj["checks"]) if obj.get("checks") is not None else None,
            "instances": GetHealth200ResponseInstances.from_dict(obj["instances"]) if obj.get("instances") is not None else None
        })
        return _obj
