...
class UpdateWebhookSourceRequest(BaseModel):
    """
    UpdateWebhookSourceRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=100)]] = Field(default=None, description="Unique source name")
    description: Optional[StrictStr] = Field(default=None, description="Description")
    expected_headers: Optional[Dict[str, StrictBool]] = Field(default=None, description="Headers to validate", alias="expectedHeaders")
    enabled: Optional[StrictBool] = Field(default=True, description="Whether enabled")
    __properties: ClassVar[List[str]] = ["name", "description", "expectedHeaders", "enabled"]
