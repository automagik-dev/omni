...
class SendPresence200ResponseData(BaseModel):
    """
    SendPresence200ResponseData
    """ # noqa: E501
    instance_id: UUID = Field(description="Instance ID", alias="instanceId")
    chat_id: StrictStr = Field(description="Chat ID where presence was sent", alias="chatId")
    type: StrictStr = Field(description="Presence type sent")
    duration: Union[StrictFloat, StrictInt] = Field(description="Duration in ms")
    __properties: ClassVar[List[str]] = ["instanceId", "chatId", "type", "duration"]
