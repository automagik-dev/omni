...
class CreateInstance201Response(BaseModel):
    """
    CreateInstance201Response
    """ # noqa: E501
    data: ListInstances200ResponseItemsInner
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ListInstances200ResponseItemsInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
