...
class CreateProvider201Response(BaseModel):
    """
    CreateProvider201Response
    """ # noqa: E501
    data: ListProviders200ResponseItemsInner
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ListProviders200ResponseItemsInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
