...
class ListEvents200ResponseMeta(BaseModel):
    """
    ListEvents200ResponseMeta
    """ # noqa: E501
    has_more: StrictBool = Field(description="Whether there are more items", alias="hasMore")
    cursor: Optional[StrictStr] = Field(description="Cursor for next page")
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["hasMore", "cursor", "total"]
