...
class BulkUpdateSettingsRequest(BaseModel):
    ...
    """ # noqa: E501
    settings: Dict[str, Any] = Field(description="Key-value pairs")
    reason: Optional[StrictStr] = Field(default=None, description="Reason for changes (audit)")
    __properties: ClassVar[List[str]] = ["settings", "reason"]
