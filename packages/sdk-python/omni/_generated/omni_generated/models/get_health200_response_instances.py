...
class GetHealth200ResponseInstances(BaseModel):
    """
    GetHealth200ResponseInstances
    """ # noqa: E501
    total: StrictInt = Field(description="Total instance count")
    connected: StrictInt = Field(description="Connected instance count")
    by_channel: Dict[str, Union[StrictFloat, StrictInt]] = Field(description="Count by channel type", alias="byChannel")
    __properties: ClassVar[List[str]] = ["total", "connected", "byChannel"]
