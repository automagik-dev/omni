...
class StartEventReplay202Response(BaseModel):
    """
    StartEventReplay202Response
    """ # noqa: E501
    data: ListReplaySessions200ResponseItemsInner
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ListReplaySessions200ResponseItemsInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
