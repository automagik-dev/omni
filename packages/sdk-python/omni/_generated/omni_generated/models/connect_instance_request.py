...
class ConnectInstanceRequest(BaseModel):
    ...
    force_new_qr: Optional[StrictBool] = Field(default=None, description="Force new QR code for WhatsApp", alias="forceNewQr")
    __properties: ClassVar[List[str]] = ["token", "forceNewQr"]
