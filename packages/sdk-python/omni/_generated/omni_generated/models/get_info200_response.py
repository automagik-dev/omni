...
class GetInfo200Response(BaseModel):
    ...
    instances: GetInfo200ResponseInstances
    events: GetInfo200ResponseEvents
    __properties: ClassVar[List[str]] = ["version", "environment", "uptime", "instances", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instances": GetInfo200ResponseInstances.from_dict(obj["instances"]) if obj.get("instances") is not None else None,
            "events": GetInfo200ResponseEvents.from_dict(obj["events"]) if obj.get("events") is not None else None
        })
        return _obj
