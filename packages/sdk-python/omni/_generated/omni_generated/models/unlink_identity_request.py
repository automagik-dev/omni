...
class UnlinkIdentityRequest(BaseModel):
    ...
    """ # noqa: E501
    identity_id: UUID = Field(description="Identity ID to unlink", alias="identityId")
    reason: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Reason for unlinking")
    __properties: ClassVar[List[str]] = ["identityId", "reason"]
