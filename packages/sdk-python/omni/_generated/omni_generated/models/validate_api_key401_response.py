...
class ValidateApiKey401Response(BaseModel):
    """
    ValidateApiKey401Response
    """ # noqa: E501
    error: ValidateApiKey401ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ValidateApiKey401ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
