...
class ListAutomations200ResponseItemsInnerTriggerConditionsInner(BaseModel):
    """
    ListAutomations200ResponseItemsInnerTriggerConditionsInner
    """ # noqa: E501
    var_field: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Dot notation field path", alias="field")
    ...
    def operator_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['eq', 'neq', 'gt', 'lt', 'gte', 'lte', 'contains', 'not_contains', 'exists', 'not_exists', 'regex']):
            raise ValueError("must be one of enum values ('eq', 'neq', 'gt', 'lt', 'gte', 'lte', 'contains', 'not_contains', 'exists', 'not_exists', 'regex')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListAutomations200ResponseItemsInnerTriggerConditionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListAutomations200ResponseItemsInnerTriggerConditionsInner from a dict"""
        if obj is None:
            return None
