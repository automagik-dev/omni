...
class GetInternalHealth200ResponseMemory(BaseModel):
    """
    GetInternalHealth200ResponseMemory
    """ # noqa: E501
    rss: Union[StrictFloat, StrictInt]
    heap_total: Union[StrictFloat, StrictInt] = Field(alias="heapTotal")
    heap_used: Union[StrictFloat, StrictInt] = Field(alias="heapUsed")
    external: Union[StrictFloat, StrictInt]
    array_buffers: Union[StrictFloat, StrictInt] = Field(alias="arrayBuffers")
    __properties: ClassVar[List[str]] = ["rss", "heapTotal", "heapUsed", "external", "arrayBuffers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rss": obj.get("rss"),
            "heapTotal": obj.get("heapTotal"),
            "heapUsed": obj.get("heapUsed"),
            "external": obj.get("external"),
            "arrayBuffers": obj.get("arrayBuffers")
        })
        return _obj
