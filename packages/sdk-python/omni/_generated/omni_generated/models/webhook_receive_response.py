...
class WebhookReceiveResponse(BaseModel):
    ...
    """ # noqa: E501
    event_id: UUID = Field(description="Created event ID", alias="eventId")
    source: StrictStr = Field(description="Webhook source name")
    event_type: StrictStr = Field(description="Event type", alias="eventType")
    __properties: ClassVar[List[str]] = ["eventId", "source", "eventType"]
