...
class GetPersonPresence200ResponseDataSummary(BaseModel):
    """
    GetPersonPresence200ResponseDataSummary
    """ # noqa: E501
    total_messages: StrictInt = Field(alias="totalMessages")
    channels: List[StrictStr]
    last_seen_at: Optional[datetime] = Field(alias="lastSeenAt")
    __properties: ClassVar[List[str]] = ["totalMessages", "channels", "lastSeenAt"]
