...
class RetryDeadLetter200Response(BaseModel):
    """
    RetryDeadLetter200Response
    """ # noqa: E501
    success: StrictBool
    dead_letter_id: Optional[UUID] = Field(default=None, alias="deadLetterId")
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["success", "deadLetterId", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deadLetterId": obj.get("deadLetterId"),
            "error": obj.get("error")
        })
        return _obj
