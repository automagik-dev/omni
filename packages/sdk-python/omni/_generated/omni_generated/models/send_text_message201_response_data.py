...
class SendTextMessage201ResponseData(BaseModel):
    """
    SendTextMessage201ResponseData
    """ # noqa: E501
    message_id: StrictStr = Field(description="Internal message ID", alias="messageId")
    external_message_id: StrictStr = Field(description="External platform message ID", alias="externalMessageId")
    status: StrictStr = Field(description="Message status")
    instance_id: Optional[UUID] = Field(default=None, description="Instance UUID", alias="instanceId")
    to: Optional[StrictStr] = Field(default=None, description="Recipient")
    media_type: Optional[StrictStr] = Field(default=None, description="Media type if applicable", alias="mediaType")
    __properties: ClassVar[List[str]] = ["messageId", "externalMessageId", "status", "instanceId", "to", "mediaType"]
