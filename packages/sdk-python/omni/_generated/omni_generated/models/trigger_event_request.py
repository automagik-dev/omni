...
class TriggerEventRequest(BaseModel):
    ...
    TriggerEventRequest
    """ # noqa: E501
    event_type: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Event type (must start with custom.)", alias="eventType")
    payload: Dict[str, Any] = Field(description="Event payload")
    correlation_id: Optional[StrictStr] = Field(default=None, description="Correlation ID", alias="correlationId")
    instance_id: Optional[UUID] = Field(default=None, description="Instance ID for context", alias="instanceId")
    __properties: ClassVar[List[str]] = ["eventType", "payload", "correlationId", "instanceId"]
