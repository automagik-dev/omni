...
class SearchEvents200Response(BaseModel):
    ...
    """ # noqa: E501
    items: List[ListEvents200ResponseItemsInner]
    meta: ListInstances200ResponseMeta
    summary: Optional[StrictStr] = None
    as_context: Optional[StrictStr] = Field(default=None, alias="asContext")
    __properties: ClassVar[List[str]] = ["items", "meta", "summary", "asContext"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ListEvents200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "meta": ListInstances200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "summary": obj.get("summary"),
            "asContext": obj.get("asContext")
        })
        return _obj
