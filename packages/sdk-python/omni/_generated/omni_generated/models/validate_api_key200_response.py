...
class ValidateApiKey200Response(BaseModel):
    """
    ValidateApiKey200Response
    """ # noqa: E501
    data: ValidateApiKey200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ValidateApiKey200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
