...
class GetRecentLogs200ResponseMeta(BaseModel):
    """
    GetRecentLogs200ResponseMeta
    """ # noqa: E501
    total: StrictInt
    buffer_size: StrictInt = Field(alias="bufferSize")
    limit: StrictInt
    __properties: ClassVar[List[str]] = ["total", "bufferSize", "limit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRecentLogs200ResponseMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRecentLogs200ResponseMeta from a dict"""
        if obj is None:
            return None
