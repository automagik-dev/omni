...
class TestAutomationRequest(BaseModel):
    ...
    """ # noqa: E501
    event: TestAutomationRequestEvent
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TestAutomationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TestAutomationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "event": TestAutomationRequestEvent.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj
