...
class ConnectInstance200Response(BaseModel):
    """
    ConnectInstance200Response
    """ # noqa: E501
    data: ConnectInstance200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ConnectInstance200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
