...
class MarkMessageRead200Response(BaseModel):
    """
    MarkMessageRead200Response
    """ # noqa: E501
    success: StrictBool
    data: MarkMessageRead200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": MarkMessageRead200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
