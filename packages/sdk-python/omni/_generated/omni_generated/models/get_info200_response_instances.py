...
class GetInfo200ResponseInstances(BaseModel):
    """
    GetInfo200ResponseInstances
    """ # noqa: E501
    total: StrictInt
    connected: StrictInt
    __properties: ClassVar[List[str]] = ["total", "connected"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetInfo200ResponseInstances from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetInfo200ResponseInstances from a dict"""
        if obj is None:
            return None
