...
class GetDeadLetterStats200ResponseData(BaseModel):
    """
    GetDeadLetterStats200ResponseData
    """ # noqa: E501
    total: StrictInt = Field(description="Total count")
    pending: StrictInt = Field(description="Pending count")
    retrying: StrictInt = Field(description="Retrying count")
    resolved: StrictInt = Field(description="Resolved count")
    abandoned: StrictInt = Field(description="Abandoned count")
    by_event_type: Dict[str, Union[StrictFloat, StrictInt]] = Field(description="Count by event type", alias="byEventType")
    __properties: ClassVar[List[str]] = ["total", "pending", "retrying", "resolved", "abandoned", "byEventType"]
