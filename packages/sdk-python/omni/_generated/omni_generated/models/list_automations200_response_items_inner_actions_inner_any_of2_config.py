...
class ListAutomations200ResponseItemsInnerActionsInnerAnyOf2Config(BaseModel):
    """
    ListAutomations200ResponseItemsInnerActionsInnerAnyOf2Config
    """ # noqa: E501
    event_type: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="eventType")
    payload_template: Optional[Dict[str, Any]] = Field(default=None, alias="payloadTemplate")
    __properties: ClassVar[List[str]] = ["eventType", "payloadTemplate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListAutomations200ResponseItemsInnerActionsInnerAnyOf2Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListAutomations200ResponseItemsInnerActionsInnerAnyOf2Config from a dict"""
        if obj is None:
            return None
