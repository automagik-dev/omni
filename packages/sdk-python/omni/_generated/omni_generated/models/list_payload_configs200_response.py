...
class ListPayloadConfigs200Response(BaseModel):
    """
    ListPayloadConfigs200Response
    """ # noqa: E501
    items: List[ListPayloadConfigs200ResponseItemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ListPayloadConfigs200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
