...
class SendTextRequest(BaseModel):
    ...
    to: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Recipient (phone number or platform ID)")
    text: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Message text")
    reply_to: Optional[StrictStr] = Field(default=None, description="Message ID to reply to", alias="replyTo")
    __properties: ClassVar[List[str]] = ["instanceId", "to", "text", "replyTo"]
