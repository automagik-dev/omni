...
class ListReplaySessions200ResponseItemsInner(BaseModel):
    """
    ListReplaySessions200ResponseItemsInner
    """ # noqa: E501
    id: UUID = Field(description="Session UUID")
    status: StrictStr = Field(description="Status")
    options: ListReplaySessions200ResponseItemsInnerOptions
    progress: ListReplaySessions200ResponseItemsInnerProgress
    __properties: ClassVar[List[str]] = ["id", "status", "options", "progress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": ListReplaySessions200ResponseItemsInnerOptions.from_dict(obj["options"]) if obj.get("options") is not None else None,
            "progress": ListReplaySessions200ResponseItemsInnerProgress.from_dict(obj["progress"]) if obj.get("progress") is not None else None
        })
        return _obj
