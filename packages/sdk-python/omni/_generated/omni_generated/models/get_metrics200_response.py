...
class GetMetrics200Response(BaseModel):
    """
    GetMetrics200Response
    """ # noqa: E501
    gauges: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = None
    counters: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = None
    histograms: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["gauges", "counters", "histograms"]
