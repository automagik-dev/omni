...
class GetSetting200Response(BaseModel):
    """
    GetSetting200Response
    """ # noqa: E501
    data: ListSettings200ResponseItemsInner
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ListSettings200ResponseItemsInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
