...
class MarkMessageRead200ResponseData(BaseModel):
    """
    MarkMessageRead200ResponseData
    """ # noqa: E501
    message_id: Optional[StrictStr] = Field(default=None, description="Internal message ID (if single message)", alias="messageId")
    external_message_id: Optional[StrictStr] = Field(default=None, description="External message ID", alias="externalMessageId")
    chat_id: Optional[StrictStr] = Field(default=None, description="Chat ID", alias="chatId")
    instance_id: Optional[UUID] = Field(default=None, description="Instance ID", alias="instanceId")
    message_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of messages marked (batch only)", alias="messageCount")
    __properties: ClassVar[List[str]] = ["messageId", "externalMessageId", "chatId", "instanceId", "messageCount"]
