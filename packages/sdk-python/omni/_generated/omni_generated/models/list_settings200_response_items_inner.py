...
class ListSettings200ResponseItemsInner(BaseModel):
    """
    ListSettings200ResponseItemsInner
    """ # noqa: E501
    key: StrictStr = Field(description="Setting key")
    value: Optional[Any] = Field(default=None, description="Setting value (masked if secret)")
    category: Optional[StrictStr] = Field(description="Category")
    is_secret: StrictBool = Field(description="Whether value is secret", alias="isSecret")
    ...
    __properties: ClassVar[List[str]] = ["key", "value", "category", "isSecret", "description", "createdAt", "updatedAt"]
