...
class ListInstanceContacts200Response(BaseModel):
    """
    ListInstanceContacts200Response
    """ # noqa: E501
    items: List[ListInstanceContacts200ResponseItemsInner]
    meta: ListInstanceContacts200ResponseMeta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ListInstanceContacts200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "meta": ListInstanceContacts200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
