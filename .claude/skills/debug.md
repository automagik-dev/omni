...
4. **Rule of 3: Question Architecture**

   **If 3+ fixes have failed:**

   - STOP attempting more fixes
   - Each fix revealing new problems = architectural issue
...
## Integration with Omni Workflow

- Use this skill BEFORE attempting fixes in `/forge`
- If debugging during QA, document findings for forge to fix
- For integration issues, use existing fixtures to create regression tests
